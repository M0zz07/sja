...
export default function Hero() {
  return (
    <section
      id="beranda"
      className="min-h-screen flex items-center relative overflow-hidden bg-[#0a0a0a] pt-[130px] px-[5%] pb-[80px]"
    >
      ...
      <div className="max-w-[640px] relative z-30">
        ...
        <p className="reveal reveal-d3 text-[1.05rem] text-[#8a8a8a] max-w-[460px] mb-[2.5rem] leading-[1.75]">
          ...
          <br />
          Material terbaik, pemasangan rapi, garansi terjamin.
        </p>

        <div className="reveal reveal-d4 flex gap-[1rem] flex-wrap">
          <a
            href="#layanan"
            className="bg-[#cc1a1a] text-white py-[0.9rem] px-[2rem] rounded-full font-bold text-[0.95rem] transition-all duration-300 shadow-[0_0_24px_rgba(204,26,26,0.18)] hover:bg-[#9e1313] hover:-translate-y-[2px] hover:shadow-[0_8px_28px_rgba(204,26,26,0.45)] inline-block"
          >
            Lihat Layanan
          </a>
          <a
            ...
            className="group bg-transparent text-[#c8c8c8] py-[0.9rem] px-[2rem] rounded-full font-bold text-[0.95rem] border border-[rgba(255,255,255,0.15)] transition-all duration-300 inline-flex items-center gap-[8px] hover:border-[#cc1a1a] hover:text-[#cc1a1a] hover:-translate-y-[2px]"
          >
            <svg
              viewBox="0 0 24 24"
              className="w-[20px] h-[20px] fill-current transition-colors duration-300"
            >
      ...
      <div className="hidden lg:block absolute right-[6%] top-1/2 -translate-y-1/2 z-[3] w-[min(38vw,420px)] animate-[fadeLeft_1s_0.6s_forwards] opacity-0">
        <Image
          src="/Logo.jpeg"
          alt="SJA Kaca Film Logo"
          width={420}
          height={420}
          className="w-full rounded-[18px] shadow-[0_0_80px_rgba(204,26,26,0.2),_0_30px_60px_rgba(0,0,0,0.6)] border border-[rgba(204,26,26,0.25)]"
        />
      </div>
    </section>
  );
